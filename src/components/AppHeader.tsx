...
export function AppHeader({
  ...
  return (
    <>
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-3">
            <div className="flex items-center gap-1.5 text-xs text-muted-foreground rounded-full bg-white/[0.04] border border-white/5 px-3 py-1.5">
              <BookOpen className="w-3.5 h-3.5 text-zinc-400" strokeWidth={1.25} />
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <div className="flex sm:hidden items-center gap-2">
              <div className="relative">
                ...
                <span className="absolute inset-0 flex items-center justify-center text-[8px] font-mono font-semibold text-emerald">
                  {pct}
                </span>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center gap-2">
              {authLoading ? (
                ...
                <div className="flex items-center gap-2">
                  <div className="hidden lg:flex items-center gap-2 rounded-full bg-white/[0.04] border border-white/5 pl-1 pr-2 py-1">
                    {user.photoURL ? (
                      ...
                      <div className="w-6 h-6 rounded-full bg-emerald/15 border border-emerald/20 flex items-center justify-center text-[10px] font-mono text-emerald">
                  ...
                  <button
                    onClick={onSignOut}
                    className="group inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/[0.04] hover:bg-white/[0.08] text-xs font-medium px-3 py-1.5 pr-1.5 text-zinc-300 hover:text-white transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.98]"
                  >
                    <span className="hidden lg:inline">Sign out</span>
                    <span className="lg:hidden">Out</span>
                    <span className="w-6 h-6 rounded-full bg-white/10 group-hover:bg-white/15 flex items-center justify-center transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:translate-x-[1px] group-hover:-translate-y-[1px] ml-1">
                      <LogOut className="w-3 h-3" strokeWidth={1.25} />
                    </span>
                  </button>
                </div>
              ) : (
                <button
                  onClick={onSignIn}
                  disabled={!!signingIn}
                  className="group inline-flex items-center gap-1 rounded-full bg-emerald hover:bg-emerald/90 text-white text-xs font-medium pl-3 pr-1 py-1 transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.98] disabled:opacity-60"
                >
                  {signingIn ? "Signing in…" : "Sign in"}
                  <span className="w-7 h-7 rounded-full bg-white text-emerald flex items-center justify-center transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:translate-x-[2px] group-hover:-translate-y-[1px] group-hover:scale-105">
            ...
            <button
              ...
              className="md:hidden w-8 h-8 rounded-full bg-white text-black flex items-center justify-center relative overflow-hidden shrink-0 active:scale-[0.96] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]"
            >
      ...
      >
        <div className="absolute inset-0 bg-black/75 backdrop-blur-3xl" onClick={() => setMenuOpen(false)} />
